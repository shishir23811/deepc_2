...
def run_experiment():
    ...
    controller = ModelPredictiveController(
        ...
        reference_kwargs={"A": 10.0, "omega": 0.1},
    )
    ...
    output_path = os.path.join(ROOT_DIR, "experiments", "figure_eight_mpc.png")
    fig.tight_layout()
    ...
    ax2.grid(True)
    ax2.legend()
    error_plot = os.path.join(ROOT_DIR, "experiments", "figure_eight_error.png")
    fig2.tight_layout()
